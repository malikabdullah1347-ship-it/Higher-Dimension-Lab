...
export function StatusBar({ currentDimension, currentModule, onOpenEpistemicLegend }: StatusBarProps) {
  return (
    <footer className="w-full border-t border-slate-800/80 bg-slate-950/90 text-xs font-mono text-slate-400 px-4 sm:px-6 py-2.5 flex flex-wrap items-center justify-between gap-3 select-none">
